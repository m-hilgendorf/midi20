...
pub use self::header::{FlexAddress, FlexStatus};
pub use self::payload::{FlexChordName, FlexKeySignature, FlexMetronome, FlexTimeSignature};
...
pub mod payload {
    use crate::message::flex::i8_from_u4;
    ...
    impl From<FlexTimeSignature> for u32 {
        fn from(value: FlexTimeSignature) -> Self {
            u32::from_le_bytes([0, value.number_of_32n, value.denominator, value.numerator])
        }
    }
...
mod tests {
    mod header {
        ...
        fn status_from_u16() {
            ...
            assert_eq!(FlexStatus::MetadataText(0.into()), 0x0100_u16.into());
            assert_eq!(
                FlexStatus::PerformanceTextEvent(0.into()),
                0x0200_u16.into()
            );
            assert_eq!(FlexStatus::Reserved(0x03_00), 0x0300_u16.into());
        }
    ...
    mod payload {
        use crate::message::{FlexChordName, FlexKeySignature, FlexMetronome, FlexTimeSignature};
        use crate::message::flex::i8_from_u4;
        use crate::message::flex::payload::FlexTempo;
